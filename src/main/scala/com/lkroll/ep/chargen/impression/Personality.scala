...
class PersonalityTable(val genderIdentity: GenderIdentity, val actualAge: Int, val currentMorph: MorphInstance)
    extends Table {
  ...
  lazy val dataVoiceTimbre: RollTableLike[String] = currentMorph.visibleGender match {
    case Some("Male") =>
      RollTable((1 to 90) -> "Male", (91 to 92) -> "Female", (93 to 95) -> "Monotone", (96 to 100) -> "Ambiguous")
    case Some("Female") =>
      RollTable((1 to 90) -> "Female", (91 to 92) -> "Male", (93 to 95) -> "Monotone", (96 to 100) -> "Ambiguous")
    case Some("Genderless") =>
      RollTable((1 to 60) -> "Ambiguous", (61 to 70) -> "Female", (71 to 80) -> "Male", (81 to 100) -> "Monotone")
    case Some(_) =>
      RollTable((1 to 3) -> "Male", (4 to 6) -> "Female", (7 to 8) -> "Monotone", (9 to 10) -> "Ambiguous")
...
object PersonalityTable {
  ...
  val dataStyle: RollTableLike[String] = Array("Doc (paternal)",
                                               "Grumpy (annoyed)",
                                               "Happy (cheerful)",
                                               "Sleepy (drowsy)",
                                               "Dopey (drugged/dumb)",
