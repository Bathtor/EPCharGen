...
class BackgroundTable(
  ...
  val backgroundLevel: PackageLevel,
  val origin:          Option[Origin] = None) extends Table {
  ...
  private sealed trait BackgroundEntry {
    def resolve(rand: Random, backgroundGroup: String): Background;
  }
  private case class UnresolvedBackground(
    label:         String,
    pkg:           PackageGroup[BackgroundPackage],
    startingMorph: RollTableLike[MorphModel]) extends BackgroundEntry {
  ...
  private lazy val data2: RollTable[BackgroundEntry] = {
    archetype match {
      case Archetype.Butterfly => RollTable(
        (1 to 3) -> UnresolvedBackground("Born with a silver nanoswarm in your blood", BackgroundPackages.hypereliteScion, MorphTables.exalt),
        (4 to 9) -> UnresolvedBackground("Celebrity child", BackgroundPackages.hypereliteMedia, MorphTables.sylph),
        (10 to 15) -> UnresolvedBackground("Privileged: enclave born", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (16 to 16) -> UnresolvedBackground("Precariat: poverty just a step away", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat),
        (17 to 17) -> UnresolvedBackground("Troubled: raised among disaster or war", BackgroundPackages.fallEvacueeUnderclass, MorphTables.flat),
        (18 to 18) -> UnresolvedBackground("Raised on the street", BackgroundPackages.streetRat, MorphTables.flat),
        (19 to 20) -> UnresolvedBackground("Raised in a collective/commune grouping", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat));
      case Archetype.Fighter => RollTable(
        (1 to 1) -> UnresolvedBackground("Born with a silver nanoswarm in your blood", BackgroundPackages.hypereliteScion, MorphTables.exalt),
        (2 to 2) -> UnresolvedBackground("Celebrity child", BackgroundPackages.hypereliteMedia, MorphTables.sylph),
        (3 to 6) -> UnresolvedBackground("Privileged: enclave born", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (7 to 9) -> UnresolvedBackground("Precariat: poverty just a step away", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat),
        (10 to 15) -> UnresolvedBackground("Troubled: raised among disaster or war", BackgroundPackages.fallEvacueeUnderclass, MorphTables.flat),
        (16 to 19) -> UnresolvedBackground("Raised on the street", BackgroundPackages.streetRat, MorphTables.flat),
        (20 to 20) -> UnresolvedBackground("Raised in a collective/commune grouping", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat));
      case Archetype.Hacker => RollTable(
        (1 to 1) -> UnresolvedBackground("Born with a silver nanoswarm in your blood", BackgroundPackages.hypereliteScion, MorphTables.exalt),
        (2 to 2) -> UnresolvedBackground("Celebrity child", BackgroundPackages.hypereliteMedia, MorphTables.sylph),
        (3 to 10) -> UnresolvedBackground("Privileged: enclave born", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (11 to 13) -> UnresolvedBackground("Precariat: poverty just a step away", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat),
        (14 to 16) -> UnresolvedBackground("Troubled: raised among disaster or war", BackgroundPackages.fallEvacueeUnderclass, MorphTables.flat),
      ...
      case Archetype.Scientist => RollTable(
        (1 to 5) -> UnresolvedBackground("Born with a silver nanoswarm in your blood", BackgroundPackages.hypereliteScion, MorphTables.exalt),
        (6 to 6) -> UnresolvedBackground("Celebrity child", BackgroundPackages.hypereliteMedia, MorphTables.sylph),
        (7 to 13) -> UnresolvedBackground("Privileged: enclave born", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (14 to 14) -> UnresolvedBackground("Precariat: poverty just a step away", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat),
        (15 to 16) -> UnresolvedBackground("Troubled: raised among disaster or war", BackgroundPackages.fallEvacueeUnderclass, MorphTables.flat),
        (17 to 17) -> UnresolvedBackground("Raised on the street", BackgroundPackages.streetRat, MorphTables.flat),
        (18 to 20) -> UnresolvedBackground("Raised in a collective/commune grouping", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat));
  ...
  private lazy val data3: RollTable[BackgroundEntry] = {
    archetype match {
      case Archetype.Butterfly => RollTable(
        ...
        (6 to 10) -> UnresolvedBackground("A new star born above the Earth", BackgroundPackages.hypereliteMedia, MorphTables.sylph),
        (11 to 14) -> UnresolvedBackground("Orbital colonist; floating above the masses", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (15 to 17) -> SubTableBackground("Orbital colony staff", colonialStaffTable),
        (18 to 19) -> UnresolvedBackground("One of the lucky few to live above", BackgroundPackages.reinstantiatedCivilian, MorphTables.lucky),
        (20 to 20) -> UnresolvedBackground("Orbital worker family", BackgroundPackages.indenture, MorphTables.indenture));
      case Archetype.Fighter => RollTable(
        (1 to 4) -> UnresolvedBackground("Orbital elite", BackgroundPackages.hypereliteScion, MorphTables.exalt),
        (5 to 5) -> UnresolvedBackground("A new star born above the Earth", BackgroundPackages.hypereliteMedia, MorphTables.sylph),
        (6 to 9) -> UnresolvedBackground("Orbital colonist; floating above the masses", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
      ...
      case Archetype.Hacker => RollTable(
        ...
        (2 to 2) -> UnresolvedBackground("A new star born above the Earth", BackgroundPackages.hypereliteMedia, MorphTables.sylph),
        (3 to 5) -> UnresolvedBackground("Orbital colonist; floating above the masses", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (6 to 12) -> SubTableBackground("Orbital colony staff", colonialStaffTable),
        (13 to 18) -> UnresolvedBackground("One of the lucky few to live above", BackgroundPackages.reinstantiatedCivilian, MorphTables.lucky),
        (19 to 20) -> UnresolvedBackground("Orbital worker family", BackgroundPackages.indenture, MorphTables.indenture));
      case Archetype.Scientist => RollTable(
        (1 to 5) -> UnresolvedBackground("Orbital elite", BackgroundPackages.hypereliteScion, MorphTables.exalt),
        (6 to 6) -> UnresolvedBackground("A new star born above the Earth", BackgroundPackages.hypereliteMedia, MorphTables.sylph),
        (7 to 10) -> UnresolvedBackground("Orbital colonist; floating above the masses", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (11 to 16) -> SubTableBackground("Orbital colony staff", colonialStaffTable),
        (17 to 19) -> UnresolvedBackground("One of the lucky few to live above", BackgroundPackages.reinstantiatedCivilian, MorphTables.lucky),
        (20 to 20) -> UnresolvedBackground("Orbital worker family", BackgroundPackages.indenture, MorphTables.indenture));
    }
  }
  ...
  private lazy val data4: RollTable[BackgroundEntry] = {
    archetype match {
      case Archetype.Butterfly => RollTable(
        ...
        (11 to 13) -> UnresolvedBackground("Lunar colonist: priviliged homesteader", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (14 to 16) -> SubTableBackground("Lunar colony staff", colonialStaffTable),
        (17 to 19) -> UnresolvedBackground("Raised with a view of Earth", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat),
      ...
      case Archetype.Fighter => RollTable(
        ...
        (6 to 10) -> UnresolvedBackground("Lunar colonist: priviliged homesteader", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (11 to 16) -> SubTableBackground("Lunar colony staff", colonialStaffTable),
        (17 to 19) -> UnresolvedBackground("Raised with a view of Earth", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat),
        (20 to 20) -> UnresolvedBackground("Lunar work force", BackgroundPackages.indenture, MorphTables.flat));
      case Archetype.Hacker => RollTable(
        (1 to 2) -> SubTableBackground("Lunar elite", lunarEliteTable),
        (3 to 8) -> UnresolvedBackground("Lunar colonist: priviliged homesteader", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (9 to 16) -> SubTableBackground("Lunar colony staff", colonialStaffTable),
        (17 to 18) -> UnresolvedBackground("Raised with a view of Earth", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat),
      ...
      case Archetype.Scientist => RollTable(
        ...
        (18 to 19) -> UnresolvedBackground("Raised with a view of Earth", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat),
        (20 to 20) -> UnresolvedBackground("Lunar work force", BackgroundPackages.indenture, MorphTables.flat));
    }
  }
  ...
  private lazy val data5: RollTable[BackgroundEntry] = {
    archetype match {
      case Archetype.Butterfly => RollTable(
        ...
        (11 to 14) -> UnresolvedBackground("Martian colonist: privileged homesteader", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (15 to 19) -> SubTableBackground("Martian colony staff", colonialStaffTable),
        (20 to 20) -> UnresolvedBackground("Risk-taking Martian settler", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat));
      case Archetype.Fighter => RollTable(
        (1 to 1) -> UnresolvedBackground("Martian elite", BackgroundPackages.hypereliteScion, MorphsOR.olympian),
        (2 to 4) -> UnresolvedBackground("Martian colonist: privileged homesteader", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (5 to 10) -> SubTableBackground("Martian colony staff", colonialStaffTable),
        (11 to 16) -> UnresolvedBackground("Risk-taking Martian settler", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat),
        (17 to 17) -> UnresolvedBackground("Martian slave labor", BackgroundPackages.indenture, MorphTables.flat),
        (18 to 20) -> UnresolvedBackground("Pre-Barsoomian Martian nomad", BackgroundPackages.drifter, MorphTables.splicerOrFlat));
      case Archetype.Hacker => RollTable(
        (1 to 1) -> UnresolvedBackground("Martian elite", BackgroundPackages.hypereliteScion, MorphsOR.olympian),
        (2 to 10) -> UnresolvedBackground("Martian colonist: privileged homesteader", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
      ...
      case Archetype.Scientist => RollTable(
        ...
        (5 to 9) -> UnresolvedBackground("Martian colonist: privileged homesteader", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (10 to 17) -> SubTableBackground("Martian colony staff", colonialStaffTable),
        (18 to 19) -> UnresolvedBackground("Risk-taking Martian settler", BackgroundPackages.reinstantiatedCivilian, MorphTables.splicerOrFlat),
        (20 to 20) -> UnresolvedBackground("Pre-Barsoomian Martian nomad", BackgroundPackages.drifter, MorphTables.splicerOrFlat));
    }
  }
  ...
  private lazy val data6: RollTable[BackgroundEntry] = {
    ...
    archetype match {
      case Archetype.Butterfly => RollTable(
        ...
        (11 to 15) -> UnresolvedBackground("Venusian colonist: privileged homesteader", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
      ...
      case Archetype.Fighter => RollTable(
        ...
        (3 to 6) -> UnresolvedBackground("Venusian colonist: privileged homesteader", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
        (7 to 17) -> SubTableBackground("Venusian colony staff", colonialStaffTable),
        (18 to 20) -> UnresolvedBackground("Mercurian slave labor", BackgroundPackages.indenture, MorphTables.flatOrCase));
      case Archetype.Hacker => RollTable(
        (1 to 1) -> UnresolvedBackground("Pioneer dynasty", BackgroundPackages.hypereliteScion, MorphTables.exalt),
        (2 to 6) -> UnresolvedBackground("Venusian colonist: privileged homesteader", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
      ...
      case Archetype.Scientist => RollTable(
        ...
        (7 to 12) -> UnresolvedBackground("Venusian colonist: privileged homesteader", BackgroundPackages.fallEvacueeEnclaver, MorphTables.splicer),
  ...
  private lazy val data7: RollTable[BackgroundEntry] = {
    archetype match {
      case Archetype.Butterfly => RollTable(
        (1 to 5) -> UnresolvedBackground("Extropia founders", BackgroundPackages.fallEvacueeEnclaver, MorphsAC.bouncer),
        (6 to 6) -> UnresolvedBackground("Jovian colonist: shelter among giants", BackgroundPackages.isolateSurvivalist, MorphTables.jovian),
        (7 to 14) -> UnresolvedBackground("Titanian colonist", BackgroundPackages.colonistScienceStaff, MorphTables.titanian),
        (15 to 19) -> UnresolvedBackground("Anarchist colonist", BackgroundPackages.colonistTechStaff, MorphTables.anarchist),
        (20 to 20) -> SubTableBackground("Small colony outpost", colonialStaffTable));
      case Archetype.Hacker => RollTable(
        (1 to 4) -> UnresolvedBackground("Extropia founders", BackgroundPackages.fallEvacueeEnclaver, MorphsAC.bouncer),
        (5 to 6) -> UnresolvedBackground("Jovian colonist: shelter among giants", BackgroundPackages.isolateSurvivalist, MorphTables.jovian),
        (7 to 10) -> UnresolvedBackground("Titanian colonist", BackgroundPackages.colonistScienceStaff, MorphTables.titanian),
        (11 to 15) -> UnresolvedBackground("Anarchist colonist", BackgroundPackages.colonistTechStaff, MorphTables.anarchist),
      ...
      case Archetype.Fighter | Archetype.Scientist => RollTable(
        (1 to 1) -> UnresolvedBackground("Extropia founders", BackgroundPackages.fallEvacueeEnclaver, MorphsAC.bouncer),
        (2 to 2) -> UnresolvedBackground("Jovian colonist: shelter among giants", BackgroundPackages.isolateSurvivalist, MorphTables.jovian),
        (3 to 3) -> UnresolvedBackground("Titanian colonist", BackgroundPackages.colonistScienceStaff, MorphTables.titanian),
        (4 to 5) -> UnresolvedBackground("Anarchist colonist", BackgroundPackages.colonistTechStaff, MorphTables.anarchist),
  ...
  private lazy val data8: RollTable[BackgroundEntry] = {
    archetype match {
      case Archetype.Butterfly => RollTable(
        ...
        (9 to 10) -> UnresolvedBackground("Supply ship crew", BackgroundPackages.colonistFlightStaff, MorphTables.supply));
      case Archetype.Fighter => RollTable(
        ...
        (8 to 8) -> UnresolvedBackground("Supply ship crew", BackgroundPackages.colonistFlightStaff, MorphTables.supply),
      ...
      case Archetype.Hacker => RollTable(
        ...
        (8 to 9) -> UnresolvedBackground("Supply ship crew", BackgroundPackages.colonistFlightStaff, MorphTables.supply),
      ...
      case Archetype.Scientist => RollTable(
        ...
        (10 to 10) -> UnresolvedBackground("Supply ship crew", BackgroundPackages.colonistFlightStaff, MorphTables.supply));
    }
  }
  ...
  private lazy val data9: RollTable[BackgroundEntry] = {
    archetype match {
      ...
      case Archetype.Hacker => RollTable(
        ...
        (9 to 9) -> UnresolvedBackground("Second-class citizenship was not for you", BackgroundPackages.upliftEscapee, MorphTables.uplifts),
        (10 to 10) -> UnresolvedBackground("Living proof that uplift works", BackgroundPackages.upliftStandard, MorphTables.uplifts));
      case Archetype.Scientist => RollTable(
        (1 to 1) -> SubTableBackground("Almost human", almostHumanTable),
  ...
  private lazy val colonialStaffTable: RollTable[BackgroundEntry] = {
    archetype match {
      case Archetype.Butterfly => RollTable(
        (1 to 8) -> UnresolvedBackground("Born to lead", BackgroundPackages.colonistCommandStaff, MorphTables.colonial1),
        (9 to 9) -> UnresolvedBackground("Space crew", BackgroundPackages.colonistFlightStaff, MorphTables.colonial2),
        (10 to 10) -> UnresolvedBackground("Researcher", BackgroundPackages.colonistScienceStaff, MorphTables.colonial4));
      case Archetype.Fighter => RollTable(
        (1 to 1) -> UnresolvedBackground("Born to lead", BackgroundPackages.colonistCommandStaff, MorphTables.colonial1),
        (2 to 2) -> UnresolvedBackground("Space crew", BackgroundPackages.colonistFlightStaff, MorphTables.colonial2),
        (3 to 10) -> UnresolvedBackground("Peacekeeper", BackgroundPackages.colonistSecurityStaff, MorphTables.colonial3));
      case Archetype.Hacker => RollTable(
        (1 to 2) -> UnresolvedBackground("Researcher", BackgroundPackages.colonistScienceStaff, MorphTables.colonial4),
        (3 to 10) -> UnresolvedBackground("You kept the habitat functioning", BackgroundPackages.colonistTechStaff, MorphTables.colonial5));
      case Archetype.Scientist => RollTable(
        (1 to 1) -> UnresolvedBackground("Born to lead", BackgroundPackages.colonistCommandStaff, MorphTables.colonial1),
        (2 to 2) -> UnresolvedBackground("Space crew", BackgroundPackages.colonistFlightStaff, MorphTables.colonial2),
        (3 to 9) -> UnresolvedBackground("Researcher", BackgroundPackages.colonistScienceStaff, MorphTables.colonial4),
        (10 to 10) -> UnresolvedBackground("You kept the habitat functioning", BackgroundPackages.colonistTechStaff, MorphTables.colonial5));
    }
  }
  ...
  private lazy val lostTable: RollTable[BackgroundEntry] = {
    archetype match {
      case Archetype.Butterfly => RollTable(
        (1 to 1) -> UnresolvedBackground("Disturbed Child (Lost Generation)", BackgroundPackages.lostDisturbed, MorphTables.futura),
        (2 to 10) -> UnresolvedBackground("Masked Normalcy (Lost Generation)", BackgroundPackages.lostMasked, MorphTables.futura));
      case Archetype.Fighter => RollTable(
        (1 to 7) -> UnresolvedBackground("Disturbed Child (Lost Generation)", BackgroundPackages.lostDisturbed, MorphTables.futura),
        (8 to 10) -> UnresolvedBackground("Masked Normalcy (Lost Generation)", BackgroundPackages.lostMasked, MorphTables.futura));
      case Archetype.Hacker | Archetype.Scientist => RollTable(
        (1 to 5) -> UnresolvedBackground("Disturbed Child (Lost Generation)", BackgroundPackages.lostDisturbed, MorphTables.futura),
        (6 to 10) -> UnresolvedBackground("Masked Normalcy (Lost Generation)", BackgroundPackages.lostMasked, MorphTables.futura));
