...
class FactionTable(val archetype: Archetype, val factionLevel: PackageLevel, val allegiance: Option[Allegiance] = None)
    extends Table {
  ...
  private def rollFromAllegiance(rand: Random, allegiance: Allegiance): Result = {
    ...
    val table: RollTableLike[TwoPackageGroup[FactionPackage]] = allegiance match {
      ...
      case Martian =>
        RollTable((1 to 35) -> barsoomian,
                  (36 to 50) -> criminal,
                  (51 to 97) -> hypercorp,
                  (98 to 98) -> sapient,
                  (99 to 100) -> socialite)
      case Belter =>
        RollTable((1 to 14) -> anarchist,
                  (15 to 70) -> belter,
                  (71 to 75) -> criminal,
                  (76 to 80) -> extropian,
                  (81 to 95) -> hypercorp,
      ...
      case Brinker => brinker
      case Criminal =>
        RollTable((1 to 80) -> criminal, (81 to 85) -> exhuman, (86 to 95) -> scum, (96 to 100) -> singularitySeeker)
      case Europan        => europan
      case BeyondHumanity => RollTable((1 to 30) -> exhuman, (31 to 80) -> singularitySeeker, (81 to 100) -> ultimate)
      case Extropian      => extropian
      case Hypercorp      => hypercorp
      case Jovian =>
        RollTable((1 to 30) -> bioconservative,
                  (31 to 90) -> jovian,
                  (91 to 98) -> preservationist,
                  (99 to 100) -> reclaimer)
      case Mercurial => RollTable((1 to 1) -> mercurialInfolife, (2 to 2) -> mercurialUplift)
      case Orbital =>
        RollTable((1 to 5) -> bioconservative,
                  (6 to 20) -> criminal,
                  (21 to 35) -> hypercorp,
                  (36 to 40) -> lunar,
                  (41 to 90) -> orbital,
      ...
      case Scum   => scum
      case Mercurian =>
        RollTable((1 to 5) -> anarchist, (6 to 10) -> criminal, (11 to 20) -> hypercorp, (21 to 100) -> sifter)
      case Socialite =>
        RollTable((1 to 5) -> hypercorp, (6 to 10) -> lunar, (11 to 95) -> socialite, (96 to 100) -> venusian)
      case Solarian => solarian
      case Titanian =>
        RollTable((1 to 5) -> anarchist, (6 to 15) -> argonaut, (16 to 99) -> titanian, (100 to 100) -> sapient)
      case Ultimate => ultimate
      case Venusian =>
        RollTable((1 to 5) -> anarchist, (6 to 15) -> criminal, (16 to 30) -> hypercorp, (31 to 100) -> venusian)
    };
