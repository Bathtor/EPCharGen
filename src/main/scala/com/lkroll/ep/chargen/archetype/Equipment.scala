...
case class Equipment(creditCost: Int,
...
class EquipmentSelection(val archetype: Archetype, val char: CharGenCharacter, val creditLimit: Int)
    extends Table
    with StrictLogging {
  ...
  override def roll(rand: Random): Result = {
    ...
    val (restCredit, creditPriority) = priority.foldLeft((creditLimit, List.empty[(EquipmentPriority, Int)])) {
      (acc, p) =>
    ...
    creditPriority.foreach { t =>
      ...
      while (creditSpent < limit && creditCost < creditLimit && retry < retryLimit) {
        logger.debug(
          s"Next selection round with creditSpent=${creditSpent}, creditCost=${creditCost}, and retry=${retry}"
        );
        pick();
      }
    }
  ...
  private def pickWeapon(rand: Random): Either[Weapon, WeaponWithAmmo] = {
    val weaponSkills = char.skills.filter(
      s =>
  ...
  private lazy val beamWeaponsData: RollTable[Weapon] = {
    ...
    archetype match {
      case Archetype.Butterfly | Archetype.Hacker | Archetype.Scientist =>
        RollTable((1 to 33) -> laserPulser, (34 to 66) -> agonizer, (67 to 100) -> stunner)
      case Archetype.Fighter =>
        RollTable((1 to 30) -> laserPulser,
                  (31 to 50) -> agonizer,
                  (61 to 70) -> bolter,
  ...
  private lazy val bladesData: RollTable[Weapon] = {
    ...
    archetype match {
      case Archetype.Butterfly | Archetype.Hacker | Archetype.Scientist =>
        RollTable((1 to 10) -> diamondAx, (11 to 20) -> flexCutter, (21 to 80) -> knife, (81 to 100) -> vibroblade)
      case Archetype.Fighter =>
        RollTable((1 to 14) -> diamondAx,
                  (15 to 30) -> flexCutter,
                  (31 to 45) -> knife,
  ...
  private lazy val clubsData: RollTable[Weapon] = {
    ...
    archetype match {
      case Archetype.Butterfly | Archetype.Hacker | Archetype.Scientist =>
        RollTable((1 to 20) -> club, (21 to 80) -> extendableBaton, (81 to 100) -> shockBaton)
      case Archetype.Fighter => RollTable((1 to 20) -> club, (21 to 60) -> extendableBaton, (61 to 100) -> shockBaton)
    }
  }
  ...
  private lazy val kineticWeaponsData: RollTable[Weapon] = {
    ...
    archetype match {
      case Archetype.Butterfly => RollTable((1 to 90) -> lightPistol, (91 to 100) -> mediumPistol)
      case Archetype.Fighter =>
        RollTable(
          (1 to 10) -> lightPistol,
  ...
  private lazy val seekerWeaponsData: RollTable[Weapon] = {
    ...
    archetype match {
      case Archetype.Butterfly | Archetype.Hacker | Archetype.Scientist =>
        RollTable((1 to 50) -> seekerArmband, (51 to 100) -> seekerPistol)
      case Archetype.Fighter =>
        RollTable(
  ...
  private lazy val sprayWeaponsData: RollTable[Weapon] = {
    ...
    archetype match {
      case Archetype.Butterfly =>
        RollTable((1 to 15) -> buzzer, (16 to 30) -> freezer, (31 to 85) -> shardPistol, (86 to 100) -> sprayer)
      case Archetype.Fighter =>
        RollTable((1 to 10) -> buzzer,
                  (11 to 20) -> freezer,
                  ...
                  (86 to 100) -> torch)
      case Archetype.Hacker =>
        RollTable((1 to 50) -> buzzer, (51 to 70) -> freezer, (71 to 90) -> shardPistol, (91 to 100) -> sprayer)
      case Archetype.Scientist =>
        RollTable((1 to 30) -> buzzer, (31 to 60) -> freezer, (61 to 70) -> shardPistol, (71 to 100) -> sprayer)
    }
  }
  ...
  private lazy val unarmedData: RollTable[Weapon] = {
    ...
    archetype match {
      case Archetype.Butterfly | Archetype.Hacker | Archetype.Scientist =>
        RollTable((1 to 50) -> densiplastGloves, (51 to 100) -> shockGloves)
      case Archetype.Fighter => RollTable((1 to 30) -> densiplastGloves, (31 to 100) -> shockGloves)
    }
  }
  ...
  private lazy val fullArmourData: RollTable[Armour] = {
    ...
    archetype match {
      case Archetype.Butterfly =>
        RollTable((1 to 50) -> armourClothing,
  ...
  private lazy val armourAccessoryData: RollTable[Armour] = {
    import ArmourEP._;
    archetype match {
      case Archetype.Butterfly => RollTable((1 to 10) -> armourVest, (11 to 70) -> secondSkin, (71 to 100) -> smartSkin)
      case Archetype.Fighter =>
        RollTable((1 to 25) -> armourVest,
  ...
  private lazy val softwareData: RollTable[Software] = {
    ...
    archetype match {
      ...
      case Archetype.Scientist =>
        RollTable((1 to 25) -> encryption, (26 to 50) -> firewall, (51 to 80) -> tacticalNetworks, (81 to 100) -> xp)
    }
  }
...
object EquipmentSelection {
  ...
  object GearPurpose {
    case object Combat extends GearPurpose {
      override lazy val gearList: List[Gear] = List(CovertTech.disabler);
    ...
    case object Social extends GearPurpose {
      override lazy val gearList: List[Gear] = List(CovertTech.shroud);
      override lazy val augmentationList: List[Augmentation] =
        List(Bioware.emotionalDampers, Bioware.endocrineControl, Bioware.enhancedPheromones, Cyberware.truthFilters);
    }
