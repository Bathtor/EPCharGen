...
class ResleeveTable(val archetype: Archetype,
  ...
  private def pickMorphType(rand: Random): MorphChoice = {
    ...
    val table: RollTableLike[MorphChoice] = archetype match {
      case Archetype.Butterfly if isAGI =>
        RollTable((1 to 20) -> Original,
                  (21 to 21) -> Uplift,
                  (22 to 30) -> Bio,
                  (31 to 35) -> Pod,
                  (36 to 80) -> Synth,
                  (81 to 100) -> Info)
      case Archetype.Butterfly if isUplift =>
        RollTable((1 to 70) -> Original,
                  (71 to 72) -> Uplift,
                  (73 to 80) -> Bio,
                  (81 to 85) -> Pod,
                  (86 to 99) -> Synth,
      ...
      case Archetype.Butterfly =>
        RollTable((1 to 50) -> Original,
                  (51 to 51) -> Uplift,
                  (52 to 80) -> Bio,
                  (81 to 82) -> Pod,
                  (83 to 99) -> Synth,
                  (100 to 100) -> Info)
      case Archetype.Fighter if isAGI =>
        RollTable((1 to 5) -> Original,
                  (6 to 7) -> Uplift,
                  (8 to 10) -> Bio,
                  (11 to 20) -> Pod,
                  (21 to 95) -> Synth,
                  (96 to 100) -> Info)
      case Archetype.Fighter if isUplift =>
        RollTable((1 to 70) -> Original,
                  (71 to 73) -> Uplift,
                  (74 to 78) -> Bio,
                  (79 to 85) -> Pod,
      ...
      case Archetype.Fighter =>
        RollTable((1 to 20) -> Original,
                  ...
                  (61 to 99) -> Synth,
                  (100 to 100) -> Info)
      case Archetype.Hacker if isAGI =>
        RollTable((1 to 60) -> Original,
                  (61 to 61) -> Uplift,
                  (62 to 62) -> Bio,
                  (63 to 65) -> Pod,
                  (66 to 75) -> Synth,
                  (76 to 100) -> Info)
      case Archetype.Hacker if isUplift =>
        RollTable((1 to 50) -> Original,
                  (51 to 51) -> Uplift,
                  (52 to 53) -> Bio,
                  (54 to 60) -> Pod,
      ...
      case Archetype.Hacker =>
        RollTable((1 to 30) -> Original,
                  (31 to 31) -> Uplift,
                  (32 to 50) -> Bio,
                  (51 to 60) -> Pod,
                  (61 to 75) -> Synth,
                  (76 to 100) -> Info)
      case Archetype.Scientist if isAGI =>
        RollTable((1 to 50) -> Original,
                  (51 to 51) -> Uplift,
                  (52 to 56) -> Bio,
                  (57 to 60) -> Pod,
                  (61 to 75) -> Synth,
                  (76 to 100) -> Info)
      case Archetype.Scientist if isUplift =>
        RollTable((1 to 70) -> Original,
                  (71 to 71) -> Uplift,
                  (72 to 73) -> Bio,
                  (74 to 80) -> Pod,
  ...
  lazy val biomorphData: RollTable[MorphModel] = {
    archetype match {
      ...
      case Archetype.Hacker =>
        RollTable((1 to 5) -> MorphsDF.flat,
  ...
  lazy val upliftData: RollTable[MorphModel] = {
    archetype match {
      case Archetype.Butterfly => RollTable((1 to 70) -> MorphsMN.neoAvian, (71 to 50) -> MorphsMN.neoHominid)
      case Archetype.Fighter =>
        RollTable((1 to 50) -> MorphsMN.neoHominid,
  ...
  lazy val podData: RollTable[MorphModel] = {
    archetype match {
      case Archetype.Butterfly =>
        RollTable((1 to 40) -> MorphsOR.pleasurePod, (41 to 50) -> MorphsGL.hypergibbon, (51 to 100) -> MorphsS.shaper)
      case Archetype.Fighter =>
        RollTable(
  ...
  lazy val infomorphData: RollTable[MorphModel] = {
    archetype match {
      case Archetype.Butterfly =>
        RollTable((1 to 50) -> MorphsGL.infomorph,
