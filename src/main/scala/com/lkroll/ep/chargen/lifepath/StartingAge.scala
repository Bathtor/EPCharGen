...
object StartingAge extends Table {
  ...
  object AptitudeTables {
    ...
    val physicalMinus10: RollTableLike[CharacterMod] = Array[CharacterMod](
      (SOM - 10),
      (REF - 10),
      (COO - 10));

    val physicalMinus5: RollTableLike[CharacterMod] = Array[CharacterMod](
      (SOM - 5),
      (REF - 5),
      (COO - 5));

    val mentalPlus5: RollTableLike[CharacterMod] = Array[CharacterMod](
      (COG + 5),
      (INT + 5),
      (SAV + 5),
      (WIL + 5));

    def any(mod: Int): RollTableLike[CharacterMod] = Array[CharacterMod](
      COG + mod,
      COO + mod,
      INT + mod,
      REF + mod,
