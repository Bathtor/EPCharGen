...
import com.lkroll.ep.compendium.{Aptitude, EPTrait, Effect, MorphModel}
...
object BackgroundEvent extends Table {
  ...
  private val data: RollTable[BGEventEntry] = RollTable(
    ...
    (21 to 22) -> CharMod("Traumatic childhood accident.",
                          TraitsNegativeEP.mentalDisorder.copy(name = "Mental Disorder (PTSD)")),
    (23 to 24) -> CharMod("You are not only good with your hands, you are good with both hands.",
                          TraitsPositiveEP.ambidextrous),
    ...
    (33 to 34) -> CharMod("You grow up in a maze-like urban area or a difficult rural area.",
                          TraitsPositiveEP.directionSense),
    (35 to 36) -> CharMod("You are raised in dangerous conditions where you have to adapt or die.",
                          TraitsPositiveEP.fastLearner),
    ...
    (41 to 42) -> CharMod("While your friends throw themselves into VR gaming worlds, you simply throw up.",
                          TraitsNegativeEP.vrVertigo),
    (43 to 44) -> CharMod("Raised in an environment of constant stimulus, you are forced to tune out.",
                          TraitsNegativeEP.oblivious),
    ...
    (55 to 56) -> CharMod("A misunderstood situation makes you the laughing stock of your peer group.",
                          TraitsNegativeTranshuman.sociallyGraceless),
    ...
    (65 to 66) -> CharMod("Your first experiments with forking prove to you that merging will not be easy.",
                          TraitsNegativeTranshuman.divergentPersonality),
    (67 to 68) -> RandMorph("You receive your first cortical stack at an early age -- and luckily just in time.",
    ...
    (75 to 76) -> CharMod("You enjoy urban exploration and getting into off-limits areas",
                          Skills.oneOf(climbing, infiltration) + 10),
    (77 to 78) -> CharMod("You hone your headshot skills in VR combat simulations.",
                          TraitsPositiveTranshuman.murderSimulatorAddict),
    (79 to 80) -> CharMod("Because you excel in your studies, you are placed in an advanced program,",
                          Aptitude.COG + 5),
    (81 to 82) -> CharMod("Your parents are highly private and extremely strict.",
                          TraitsNegativeTranshuman.poorlySocialized),
    (83 to 84) -> CharMod("You leave home at an early age and forge your own path.", CharacterMod.Moxie(1)),
    (85 to 86) -> CharMod(
      "One of your personality quirks gains you some attention from peers, but then it becomes a permanent and noticeable part of your daily behaviour.",
      TraitsNegativeTranshuman.identifiablyQuirk
    ),
    (87 to 88) -> CharMod("As a free-range kid, you learn how to get around on your own.", navigation + 10),
    (89 to 90) -> CharMod("One of your parental figures abandons you as a child.",
                          TraitsNegativeTranshuman.trustingHeart),
    (91 to 92) -> CharMod("A series of childhood injuries leaves you struggling to catch up physically.",
                          Aptitude.SOM - 5),
    (93 to 94) -> CharMod("You lose all of your close friends in a horribly awkward teen social situation.",
                          TraitsNegativeTranshuman.notATeamPlayer),
    (95 to 96) -> CharMod("Tormented by bullies as a kid, you learn to stand up for yourself.", unarmedCombat + 10),
    (97 to 98) -> CharMod("The strictness of your parents leaves you only one choice: to excel at lying.",
                          deception + 10),
    (99 to 100) -> CharMod(
      "Adult generations are never quite as on-top of technological changes, and you use that to your advantage.",
      infosec + 10
    )
  );
