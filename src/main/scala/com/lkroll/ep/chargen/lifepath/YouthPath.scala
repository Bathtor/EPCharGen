...
case class ConcreteChildhood(label: String,
                             group: String,
...
object YouthPathTable extends Table {
  ...
  private lazy val data2: RollTable[ChildhoodEntry] = RollTable(
    (1 to 1) -> Childhood("Born with a silver nanoswarm in your blood",
                          BackgroundPackages.hypereliteScion,
                          MorphTables.exalt,
                          NextPathTables.elite),
    (2 to 2) -> Childhood("Celebrity child",
                          BackgroundPackages.hypereliteMedia,
                          MorphTables.sylph,
                          NextPathTables.elite),
    (3 to 5) -> Childhood("Privileged: enclave born",
                          BackgroundPackages.fallEvacueeEnclaver,
                          MorphTables.splicer,
                          NextPathTables.enclaver),
    (6 to 7) -> Childhood("Precariat: poverty just a step away",
                          BackgroundPackages.reinstantiatedCivilian,
                          MorphTables.splicerOrFlat,
                          NextPathTables.civilian),
    (8 to 8) -> Childhood("Troubled: raised among disaster or war",
                          BackgroundPackages.fallEvacueeUnderclass,
                          MorphTables.flat,
                          NextPathTables.cca),
    (9 to 9) -> Childhood("Raised on the street",
                          BackgroundPackages.streetRat,
                          MorphTables.flat,
                          NextPathTables.criminal),
    (10 to 10) -> Childhood("Raised in a collective/commune grouping",
                            BackgroundPackages.reinstantiatedCivilian,
                            MorphTables.splicerOrFlat,
                            NextPathTables.autonomist)
  );
  ...
  private lazy val data3: RollTable[ChildhoodEntry] = RollTable(
    ...
    (2 to 2) -> Childhood("A new star born above the Earth",
                          BackgroundPackages.hypereliteMedia,
                          MorphTables.sylph,
                          NextPathTables.elite),
    (3 to 4) -> Childhood("Orbital colonist; floating above the masses",
                          BackgroundPackages.fallEvacueeEnclaver,
                          MorphTables.splicer,
                          NextPathTables.enclaver),
    (5 to 6) -> SubTableChildhood("Orbital colony staff", colonialStaffTable),
    (7 to 8) -> Childhood("One of the lucky few to live above",
                          BackgroundPackages.reinstantiatedCivilian,
                          MorphTables.lucky,
                          NextPathTables.civilian),
    (9 to 10) -> Childhood("Orbital worker family",
                           BackgroundPackages.indenture,
                           MorphTables.indenture,
                           NextPathTables.indenture)
  );

  private lazy val data4: RollTable[ChildhoodEntry] = RollTable(
    (1 to 1) -> SubTableChildhood("Lunar elite", lunarEliteTable),
    (2 to 3) -> Childhood("Lunar colonist: priviliged homesteader",
                          BackgroundPackages.fallEvacueeEnclaver,
                          MorphTables.splicer,
                          NextPathTables.enclaver),
    (4 to 5) -> SubTableChildhood("Lunar colony staff", colonialStaffTable),
    (6 to 7) -> Childhood("Raised with a view of Earth",
                          BackgroundPackages.reinstantiatedCivilian,
                          MorphTables.splicerOrFlat,
                          NextPathTables.civilian),
  ...
  private lazy val data5: RollTable[ChildhoodEntry] = RollTable(
    ...
    (2 to 3) -> Childhood("Martian colonist: privileged homesteader",
                          BackgroundPackages.fallEvacueeEnclaver,
                          MorphTables.splicer,
                          NextPathTables.enclaver),
    (4 to 5) -> SubTableChildhood("Martian colony staff", colonialStaffTable),
    (6 to 6) -> Childhood("Risk-taking Martian settler",
                          BackgroundPackages.reinstantiatedCivilian,
                          MorphTables.splicerOrFlat,
                          NextPathTables.civilian),
    (7 to 9) -> Childhood("Martian slave labor",
                          BackgroundPackages.indenture,
                          MorphTables.flat,
                          NextPathTables.indenture),
    (10 to 10) -> Childhood("Pre-Barsoomian Martian nomad",
  ...
  private lazy val data6: RollTable[ChildhoodEntry] = RollTable(
    (1 to 1) -> Childhood("Pioneer dynasty",
                          BackgroundPackages.hypereliteScion,
                          MorphTables.exalt,
                          NextPathTables.elite),
    (2 to 3) -> Childhood("Venusian colonist: privileged homesteader",
                          BackgroundPackages.fallEvacueeEnclaver,
                          MorphTables.splicer,
                          NextPathTables.enclaver),
    (4 to 6) -> SubTableChildhood("Venusian colony staff", colonialStaffTable),
    (7 to 10) -> Childhood("Mercurian slave labor",
                           BackgroundPackages.indenture,
  ...
  private lazy val data7: RollTable[ChildhoodEntry] = RollTable(
    (1 to 1) -> Childhood("Extropia founders",
                          BackgroundPackages.fallEvacueeEnclaver,
                          MorphsAC.bouncer,
                          NextPathTables.elite),
    (2 to 2) -> Childhood("Jovian colonist: shelter among giants",
                          BackgroundPackages.isolateSurvivalist,
                          MorphTables.jovian,
                          NextPathTables.military),
    (3 to 3) -> Childhood("Titanian colonist",
                          BackgroundPackages.colonistScienceStaff,
                          MorphTables.titanian,
                          NextPathTables.scientist),
    (4 to 5) -> Childhood("Anarchist colonist",
  ...
  private lazy val data8: RollTable[ChildhoodEntry] = RollTable(
    (1 to 3) -> Childhood("Wandering the system",
                          BackgroundPackages.drifter,
                          MorphTables.anarchist,
                          NextPathTables.spacer),
    (4 to 5) -> Childhood("Found freedom in orbit",
                          BackgroundPackages.originalScum,
                          MorphTables.scum,
                          NextPathTables.autonomist),
    (6 to 8) -> Childhood("Supply ship crew",
  ...
  private lazy val data9: RollTable[ChildhoodEntry] = RollTable(
    ...
    (9 to 9) -> Childhood("Second-class citizenship was not for you",
                          BackgroundPackages.upliftEscapee,
                          ChoosingAMorph.uplifts,
                          NextPathTables.civilian),
    (10 to 10) -> Childhood("Living proof that uplift works",
  ...
  private lazy val colonialStaffTable: RollTable[ChildhoodEntry] = RollTable(
    (1 to 1) -> Childhood("Born to lead",
                          BackgroundPackages.colonistCommandStaff,
                          MorphTables.colonial1,
                          NextPathTables.enclaver),
    (2 to 3) -> Childhood("Space crew",
                          BackgroundPackages.colonistFlightStaff,
                          MorphTables.colonial2,
                          NextPathTables.spacer),
    (4 to 5) -> Childhood("Peacekeeper",
                          BackgroundPackages.colonistSecurityStaff,
                          MorphTables.colonial3,
                          NextPathTables.military),
    (6 to 7) -> Childhood("Researcher",
                          BackgroundPackages.colonistScienceStaff,
                          MorphTables.colonial4,
                          NextPathTables.scientist),
    (8 to 10) -> Childhood("You kept the habitat functioning",
                           BackgroundPackages.colonistTechStaff,
                           MorphTables.colonial5,
                           NextPathTables.techie)
  );
  ...
  private lazy val almostHumanTable: RollTable[ChildhoodEntry] = RollTable(
    (1 to 3) -> Childhood(
      "Post-Fall AGI",
      BackgroundPackages.infolifeHumanities,
      MorphTables.infomorph,
      NextPathTables.civilian,
      skipPreFallReason = Some("Post-Fall AGI"),
      mustComeFirst = true
    ),
    (4 to 10) -> Childhood("Pre-Fall AGI",
                           BackgroundPackages.infolifeHumanities,
                           MorphTables.infomorph,
                           NextPathTables.civilian,
                           mustComeFirst = true)
  ...
  private lazy val machineTable: RollTable[ChildhoodEntry] = RollTable(
    (1 to 3) -> Childhood(
      "Post-Fall AGI",
      BackgroundPackages.infolifeMachine,
      MorphTables.infomorph,
      NextPathTables.techie,
      skipPreFallReason = Some("Post-Fall AGI"),
      mustComeFirst = true
  ...
  private lazy val scienceTable: RollTable[ChildhoodEntry] = RollTable(
    (1 to 3) -> Childhood(
      "Post-Fall AGI",
      BackgroundPackages.infolifeResearch,
      MorphTables.infomorph,
      NextPathTables.scientist,
      skipPreFallReason = Some("Post-Fall AGI"),
      mustComeFirst = true
  ...
  private lazy val lostTable: RollTable[ChildhoodEntry] = RollTable(
    (1 to 5) -> Childhood(
      "Disturbed Child (Lost Generation)",
      BackgroundPackages.lostDisturbed,
      MorphTables.futura,
      NextPathTables.newPath,
      skipPreFallReason = Some("Lost"),
      mustComeFirst = true
    ),
    (6 to 10) -> Childhood(
      "Masked Normalcy (Lost Generation)",
  ...
  private object NextPathTables {
    ...
    val cca = RollTable((1 to 5) -> AdultPathIndex(4), (6 to 9) -> AdultPathIndex(3), (10 to 10) -> AdultPathIndex(2));
